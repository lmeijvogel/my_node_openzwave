...
const zwave: OpenZWave = new ZWaveFactory(testMode).create();
...
(function() {
    ...
    function initMyZWave(zwave, lights) {
        ...
        myZWave.onValueChange(function(node, commandClass, value) {
            ...
            if (!lightName) {
                Logger.error(
                    'Unknown light with nodeId %d. Command class: %d, value: "',
                    node.nodeId,
                    commandClass,
                    value,
                    '"'
                ...
                Logger.error(
                    'Unknown light with name "%s" (id: %d). Command class: %d, value: "',
                    lightName,
                    node.nodeId,
                    commandClass,
                    value,
